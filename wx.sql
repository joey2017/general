...
Source Server         : 112.124.8.246（讯丰）
Source Server Version : 50720
Source Host           : 112.124.8.246:3306
Source Database       : wx
...
CREATE TABLE `system_app` (
  ...
  `is_bind_domain` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否绑定域名：0否1是',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `system_app` VALUES ('3', 'momo', 'wxf4e5f61fb077f79a', 'fd5fa724ea5489a1805f9ac50de8bc9c', null, null, '0', '1', '0', '2019-02-27 11:16:17', '0');
INSERT INTO `system_app` VALUES ('4', '', 'wxf4e5f61fb077f79a', 'fd5fa724ea5489a1805f9ac50de8bc9c', null, null, '0', '1', '1', '2019-02-27 17:10:32', '0');
...
INSERT INTO `system_config` VALUES ('43', 'safe_link', 'http://b.xunfengkj.com');
INSERT INTO `system_config` VALUES ('44', 'share_link', 'http://s2.app1108263300.qqopenapp.com/qrvide.php');
INSERT INTO `system_config` VALUES ('45', 'not_wx_link', 'https://weixin110.qq.com/cgi-bin/mmspamsupport-bin/newredirectconfirmcgi?block_type=20&url=weixin.com');
...
INSERT INTO `system_config` VALUES ('52', 'video_link', 'f07531cxoyb');
...
CREATE TABLE `system_domain` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(32) DEFAULT '' COMMENT '域名',
  ...
  `create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='域名管理表';

-- ----------------------------
-- Records of system_domain
-- ----------------------------
INSERT INTO `system_domain` VALUES ('5', 'b.xunfengkj.com', null, '2', '0', '1', '0', '2019-03-01 08:56:35');
INSERT INTO `system_domain` VALUES ('6', 'a.xunfengkj.com', null, '1', '0', '1', '0', '2019-03-01 09:31:09');
INSERT INTO `system_domain` VALUES ('7', 's11.app1107908963.qqopenapp.com', '3', '1', '0', '0', '0', '2019-03-07 18:19:30');
INSERT INTO `system_domain` VALUES ('8', 's2.app1108264154.qqopenapp.com', '3', '1', '0', '1', '0', '2019-03-07 22:53:48');
INSERT INTO `system_domain` VALUES ('9', 's4.app1108263300.qqopenapp.com', '3', '1', '0', '1', '0', '2019-03-07 22:54:04');
INSERT INTO `system_domain` VALUES ('10', 's4.app1108264154.qqopenapp.com', '3', '1', '0', '1', '0', '2019-03-07 22:54:17');
INSERT INTO `system_domain` VALUES ('11', 's5.app1108264154.qqopenapp.com', '3', '1', '0', '1', '0', '2019-03-07 22:54:34');
INSERT INTO `system_domain` VALUES ('12', 's2.app1108263300.qqopenapp.com', '3', '1', '0', '1', '0', '2019-03-07 22:54:51');
...
INSERT INTO `system_log` VALUES ('38', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-02-28 15:43:07');
INSERT INTO `system_log` VALUES ('39', '127.0.0.1', 'admin/wechat/index', 'admin', '公众号管理', '公众号参数配置成功', '2019-03-01 09:08:37');
INSERT INTO `system_log` VALUES ('40', '127.0.0.1', 'admin/video/index', 'admin', '视频管理', '视频参数配置成功', '2019-03-04 17:07:15');
INSERT INTO `system_log` VALUES ('41', '127.0.0.1', 'admin/wechat/index', 'admin', '公众号管理', '公众号参数配置成功', '2019-03-05 11:12:05');
INSERT INTO `system_log` VALUES ('42', '127.0.0.1', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-03-06 16:34:35');
INSERT INTO `system_log` VALUES ('43', '116.8.56.92', 'admin/wechat/index', 'admin', '公众号管理', '公众号参数配置成功', '2019-03-07 15:43:35');
INSERT INTO `system_log` VALUES ('44', '182.88.133.108', 'admin/login/index', 'admin', '系统管理', '用户登录系统成功', '2019-03-07 22:52:56');
...
INSERT INTO `system_menu` VALUES ('46', '45', '视频管理列表', '', 'fa fa-film', 'admin/video/index', '', '_self', '0', '1', '0', '2019-02-26 16:58:12');
...
INSERT INTO `system_menu` VALUES ('50', '49', '群分享设置', '', 'layui-icon layui-icon-group', 'admin/share/index', 'type=1', '_self', '0', '1', '0', '2019-02-26 18:20:21');
INSERT INTO `system_menu` VALUES ('51', '49', '朋友圈分享设置', '', 'fa fa-qq', 'admin/share/index', 'type=2', '_self', '0', '1', '0', '2019-02-26 18:24:32');
...
INSERT INTO `system_menu` VALUES ('55', '1', '域名管理', '', '', '#', '', '_self', '0', '1', '0', '2019-02-28 17:36:05');
INSERT INTO `system_menu` VALUES ('56', '55', '域名列表', '', 'layui-icon layui-icon-website', 'admin/domain/index', '', '_self', '0', '1', '0', '2019-02-28 17:36:53');
...
-- ----------------------------
-- Table structure for system_share
-- ----------------------------
DROP TABLE IF EXISTS `system_share`;
CREATE TABLE `system_share` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(32) DEFAULT '' COMMENT '二维码图片',
  `content` varchar(255) DEFAULT NULL COMMENT '内容',
  `type` tinyint(1) DEFAULT NULL COMMENT '类型：1=>群分享，2=>圈分享',
  `title` varchar(255) DEFAULT NULL COMMENT '分享标题',
  `desc` varchar(255) DEFAULT NULL COMMENT '分享描述',
  `link` varchar(255) DEFAULT NULL COMMENT '分享图片链接',
  `sort` int(11) unsigned DEFAULT '0' COMMENT '分享排序',
  `status` tinyint(1) unsigned DEFAULT '1' COMMENT '分享状态(1有效,0无效)',
  `is_deleted` tinyint(1) unsigned DEFAULT '0' COMMENT '删除状态(1删除,0未删除)',
  `create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='分享管理表';

-- ----------------------------
-- Records of system_share
-- ----------------------------
INSERT INTO `system_share` VALUES ('7', '圈分享1', '分享成功，剩下最后一步啦！<br />请分享到<span style=\"font-size: 30px;color: #f5294c\">朋友圈</span>即可领取!', '2', '都来看看瞧瞧，不要钱，通通不要钱', '58115', 'https://upload-images.jianshu.io/upload_images/15750393-2ce4bfb476232ec7.png', '1', '1', '0', '2019-03-04 17:28:29');
INSERT INTO `system_share` VALUES ('8', '群分享1', '网速不好，请分享到 <span style=\"font-size: 30px;color: #f5294c\">3</span> 个不同的微信群才可以继续观看！', '1', '151523daf', 'hello', 'https://upload-images.jianshu.io/upload_images/15657969-714f794f531cc0d4.png', '1', '1', '0', '2019-03-04 17:30:08');
INSERT INTO `system_share` VALUES ('9', '群分享3', '分享成功，剩下最后一步啦！<br />请分享到<span style=\"font-size: 30px;color: #f5294c\">朋友圈</span>即可观看!', '1', '151523daf', 'hello', 'https://upload-images.jianshu.io/upload_images/15657969-714f794f531cc0d4.png', '3', '1', '0', '2019-03-04 17:44:14');
INSERT INTO `system_share` VALUES ('10', '群分享2', '分享<span style=\"font-size: 30px;color: #f5294c\">分享成功</span>,请继续分享到不同的群！', '1', '151523daf', 'hello', 'https://upload-images.jianshu.io/upload_images/15657969-714f794f531cc0d4.png', '2', '1', '0', '2019-03-06 17:07:57');
INSERT INTO `system_share` VALUES ('11', '圈分享2', '分享朋友圈<span style=\"font-size: 30px;color: #f5294c\">失败</span>,请继续分享朋友圈！', '2', '都来看看瞧瞧，不要钱，通通不要钱', '58115', 'https://upload-images.jianshu.io/upload_images/15750393-2ce4bfb476232ec7.png', '2', '1', '0', '2019-03-06 17:24:53');
...
-- ----------------------------
INSERT INTO `system_user` VALUES ('10000', 'admin', '21232f297a57a5a743894a0e4a801fc3', '22222222', '', '', '', '22987', '2019-03-07 22:52:56', '1', '2,4', '0', null, '2015-11-13 15:14:22');
...
CREATE TABLE `system_video` (
  ...
  `vid` varchar(64) DEFAULT NULL COMMENT '视频vid',
  `pause` int(11) DEFAULT NULL COMMENT '暂停播放秒数',
  `read_min` int(11) DEFAULT '0' COMMENT '视频最小阅读量',
  `read_max` int(11) DEFAULT '0' COMMENT '视频最大阅读量',
  `image` varchar(255) DEFAULT '' COMMENT '视频图片',
  `stars` int(11) DEFAULT '0' COMMENT '视频点赞数',
  `sort` int(11) unsigned DEFAULT '0' COMMENT '分享排序',
  `status` tinyint(1) unsigned DEFAULT '1' COMMENT '分享状态(1有效,0无效)',
  `is_deleted` tinyint(1) unsigned DEFAULT '0' COMMENT '删除状态(1删除,0未删除)',
  `create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='视频管理表';

-- ----------------------------
-- Records of system_video
-- ----------------------------
INSERT INTO `system_video` VALUES ('10', '女总裁被女同学当畜生羞辱，当场大怒，结局所有人都吓傻了！', 'e0632jmb3wf', '297', '1002', '5000', 'http://wx1.sinaimg.cn/sq612/00669utAgy1fu9ahbo728j30al0akthr.jpg', '800', '1', '1', '0', '2019-03-06 17:30:59');
INSERT INTO `system_video` VALUES ('11', '农村小伙救了女总裁一命, 流落街头女总裁开着宝马找他报恩, 三年后...', 't06631l66ap', '151', '18815', '151885', 'https://wx4.sinaimg.cn/mw690/005SSfhzgy1fu29p326apj30mr0ckdyv.jpg', '12482', '3', '1', '0', '2019-03-06 17:48:44');
