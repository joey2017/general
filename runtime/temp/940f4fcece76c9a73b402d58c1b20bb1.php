<?php /*a:2:{s:64:"D:\phpStudy\WWW\general\application\admin\view\qrcode\index.html";i:1554776922;s:66:"D:\phpStudy\WWW\general\application\admin\view\public\content.html";i:1550126539;}*/ ?>
<!-- 右则内容区域 开始 -->
...
<button data-open='<?php echo url("$classuri/add"); ?>' data-title="添加二维码" class='layui-btn layui-btn-sm layui-btn-info'>添加二维码</button>
<!--<?php endif; ?>-->

<!--<?php if(auth("$classuri/del")): ?>-->
<button data-update="" data-field='delete' data-action='<?php echo url("$classuri/del"); ?>' class='layui-btn layui-btn-sm layui-btn-danger'>删除二维码</button>
<!--<?php endif; ?>-->
...
<form autocomplete="off" class="layui-form layui-form-pane form-search" action="<?php echo request()->url(); ?>" onsubmit="return false" method="get">
    ...
    <div class="layui-form-item layui-inline">
        ...
        <div class="layui-input-inline">
            <input name="title" value="<?php echo htmlentities(app('request')->get('title')); ?>" placeholder="请输入二维码名称" class="layui-input">
        </div>
    </div>

    <div class="layui-form-item layui-inline">
        <label class="layui-form-label">二维码状态</label>
        <div class="layui-input-inline">
...
<form onsubmit="return false;" data-auto="true" method="post">
    ...
    <table class="layui-table" lay-skin="line">
        ...
        <tr>
            ...
            <th class='text-left nowrap'>二维码名称</th>
            <th class='text-left nowrap'>二维码图片</th>
            <th class='text-left nowrap'>添加时间</th>
            <th class='text-left nowrap'>二维码状态</th>
        ...
        <tr>
            ...
            <td class='text-left nowrap'><?php echo htmlentities($vo['pic']); ?></td>
            ...
            <td class='text-left nowrap'>
                ...
                <a data-title="编辑二维码" data-open='<?php echo url("$classuri/edit"); ?>?id=<?php echo htmlentities($vo['id']); ?>'>编辑</a>
