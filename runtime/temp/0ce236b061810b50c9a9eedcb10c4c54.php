<?php /*a:1:{s:61:"D:\phpStudy\WWW\general\application\admin\view\menu\form.html";i:1554771484;}*/ ?>
<form autocomplete="off" class="layui-form layui-box modal-form-box" action="<?php echo request()->url(); ?>" data-auto="true" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <span class='layui-btn layui-btn-info' style='padding:0 12px;min-width:45px'>
            <i id='icon-preview' style='font-size:1.2em' class='<?php echo htmlentities((isset($vo['icon']) && ($vo['icon'] !== '')?$vo['icon']:"")); ?>'></i>
        </span>
            <button data-icon='icon' type='button' class='layui-btn layui-btn-info'>选择图标</button>
