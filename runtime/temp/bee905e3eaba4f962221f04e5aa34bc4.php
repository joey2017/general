...
<button data-open='<?php echo url("$classuri/add"); ?>' data-title="添加视频" class='layui-btn layui-btn-sm layui-btn-info'>添加视频</button>
<!--<?php endif; ?>-->

<!--<?php if(auth("$classuri/del")): ?>-->
<button data-update="" data-field='delete' data-action='<?php echo url("$classuri/del"); ?>' class='layui-btn layui-btn-sm layui-btn-danger'>删除视频</button>
<!--<?php endif; ?>-->
...
<form autocomplete="off" class="layui-form layui-form-pane form-search" action="<?php echo request()->url(); ?>" onsubmit="return false" method="get">
    ...
    <div class="layui-form-item layui-inline">
        ...
        <div class="layui-input-inline">
            <input name="title" value="<?php echo htmlentities(app('request')->get('title')); ?>" placeholder="请输入视频标题" class="layui-input">
        </div>
    </div>
    ...
    <table class="layui-table" lay-skin="line">
        ...
        <tr>
            ...
            <td class='text-left nowrap'>
                ...
                <a data-title="编辑视频" data-open='<?php echo url("$classuri/edit"); ?>?id=<?php echo htmlentities($vo['id']); ?>'>编辑</a>
