...
INSERT INTO `system_config` VALUES ('44', 'share_link', 'http://b.xunfengkj.com');
...
CREATE TABLE `system_domain` (
  ...
  `create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='域名管理表';
...
-- ----------------------------
INSERT INTO `system_user` VALUES ('10000', 'admin', '21232f297a57a5a743894a0e4a801fc3', '22222222', '', '', '', '22986', '2019-03-06 16:34:35', '1', '2,4', '0', null, '2015-11-13 15:14:22');
